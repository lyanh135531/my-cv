...
import { Sparkles, Zap, ShieldCheck, Download, Code, Globe, Palette } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: 'A beautiful, dark-mode editing experience that keeps you focused and inspired.'
    }
  ];
    ...
    <div className="landing-page-wrapper">
      <header className="glass-panel" style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <h2 className="text-gradient" style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800 }}>ResumeAI</h2>
        </div>
        <nav style={{ display: 'none' }} className="md-flex">
            <div style={{ display: 'flex', gap: '2rem' }}>
              <a href="#" style={{ color: 'var(--text-secondary)', fontWeight: 500 }}>Features</a>
              <a href="#" style={{ color: 'var(--text-secondary)', fontWeight: 500 }}>Templates</a>
              <a href="#" style={{ color: 'var(--text-secondary)', fontWeight: 500 }}>Pricing</a>
            </div>
        </nav>
